...
当前参考构建下，安装包约 `5.90 MB`，这些数字会随版本、ABI 与构建配置变化。
...
| Style | Low / High Hz | 听感目标 | 输入内容 |
| :--- | :--- | :--- | :--- |
| [Litany](docs/design/modes/flash/litany.md) | `220 / 440` | 低沉、肃穆、吟诵 | `rs` |
| [Collapse](docs/design/modes/flash/collapse.md) | `226-320 / 452-640` | 低声、慌张、结巴 | `github` |
| [Standard](docs/design/modes/flash/standard.md) | `300 / 600` | 日常、精确、平稳 | `github` |
| [Hostility](docs/design/modes/flash/hostility.md) | `438-536 / 876-1072` | 尖锐、急促、攻击 | `github` |
| [Zeal](docs/design/modes/flash/zeal.md) | `560-900 / 1120-1800` | 明亮、变速、密集 | `github` |
| [Void](docs/design/modes/flash/void.md) | `240 / 480` | 低沉、拖尾、稀疏 | `github` |

[flash-void-github.wav](https://github.com/user-attachments/files/27785902/flash-void-github.wav)
[flash-standard-github.wav](https://github.com/user-attachments/files/27785898/flash-standard-github.wav)
[flash-litany-rs.wav](https://github.com/user-attachments/files/27785896/flash-litany-rs.wav)
[flash-hostility-github.wav](https://github.com/user-attachments/files/27785887/flash-hostility-github.wav)
[flash-collapse-github.wav](https://github.com/user-attachments/files/27785877/flash-collapse-github.wav)
[flash-zeal-github.wav](https://github.com/user-attachments/files/27785875/flash-zeal-github.wav)
