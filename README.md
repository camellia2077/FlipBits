...
当前参考构建下，安装包约 `6.19 MB`(按 Android 系统千进制换算)，这些数字会随版本、ABI 与构建配置变化。
...
- **[ 8.8s ]** **Litany**: [flash[litany]_rs.wav](https://github.com/user-attachments/files/27856247/flash.litany._rs.wav)
...
- **下载地址**: [pro_RED STEEL RECE.wav](https://github.com/user-attachments/files/27856440/pro_RED.STEEL.RECE.wav)
...
**文本内容**：`赤红钢铁在重锤之下领受其序列号`

| 模式 | 风格 | 耗时 | 下载 |
| :--- | :--- | :--- | :--- |
| **`ultra`** | **默认** | **4.50s** | [下载音频](https://github.com/user-attachments/files/27856491/ultra_.wav)|
| `flash` | Zeal (极速) | 11.55s | [下载音频](https://github.com/user-attachments/files/27856457/flash.zeal._.wav)
| `flash` | Standard (标准) | 17.17s | [下载音频](https://github.com/user-attachments/files/27856460/flash.standard._.wav)|
| `flash` | Litany (肃穆) | 144.85s | [下载音频](https://github.com/user-attachments/files/27856479/flash.litany._.wav) |

> **注**：`litany` 风格音频时长为 3 分 7.2 秒，这是为了“风格化”有意设计的刻意冗余，旨在达到人类可清晰辨识、记录甚至朗读的频率间隔。
