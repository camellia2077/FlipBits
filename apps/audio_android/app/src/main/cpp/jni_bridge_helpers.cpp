...
jclass FindClassOrNullForHelperResult(JNIEnv* env, const char* name) {
...
jobject NewDecodedAudioPayloadResult(JNIEnv* env,
                                     ...
                                     jobject follow_data) {
    jclass result_class = FindClassOrNullForHelperResult(env, "com/bag/audioandroid/domain/DecodedAudioPayloadResult");
...
jobject NewEncodedAudioPayloadResult(JNIEnv* env,
                                     ...
                                     jobject follow_data,
                                     jint terminal_code) {
    jclass result_class = FindClassOrNullForHelperResult(env, "com/bag/audioandroid/domain/EncodedAudioPayloadResult");
    if (result_class == nullptr) {
        return nullptr;
    }
    jmethodID ctor =
...
jobject NewFlashSignalInfo(JNIEnv* env,
                           ...
                           jboolean available) {
    jclass result_class = FindClassOrNullForHelperResult(env, "com/bag/audioandroid/domain/FlashSignalInfo");
    if (result_class == nullptr) {
        return nullptr;
    }
    jmethodID ctor =
