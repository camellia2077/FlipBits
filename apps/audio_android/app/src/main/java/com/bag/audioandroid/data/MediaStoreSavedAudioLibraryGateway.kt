...
class MediaStoreSavedAudioLibraryGateway(
        ...
        val imported =
            runCatching {
                ...
                findSavedAudioItem(itemId) ?: SavedAudioItem(
                    ...
                    savedAtEpochSeconds =
                        decoded.metadata?.createdAtIsoUtc?.let(::parseCreatedAtEpochSeconds)
    ...
    private fun findSavedAudioItem(itemId: String): SavedAudioItem? = listSavedAudio().firstOrNull { it.itemId == itemId }
