...
interface PlaybackRuntimeGateway {
    ...
    fun load(totalSamples: Int, sampleRateHz: Int): PlaybackUiState
    ...
    fun progress(state: PlaybackUiState, playedSamples: Int): PlaybackUiState
    fun scrubStarted(state: PlaybackUiState): PlaybackUiState
    fun scrubChanged(state: PlaybackUiState, targetSamples: Int): PlaybackUiState
    ...
    fun clampSamples(totalSamples: Int, sampleIndex: Int): Int
    fun fractionToSamples(totalSamples: Int, fraction: Float): Int
