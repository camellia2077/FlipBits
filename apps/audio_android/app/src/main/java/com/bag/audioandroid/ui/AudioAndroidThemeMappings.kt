    ...
    return when (selectedThemeStyle) {
        ThemeStyleOption.BrandDualTone -> {
            OutlinedTextFieldDefaults.colors(
                ...
                focusedSupportingTextColor = visualTokens.inputContentColor.copy(alpha = 0.86f),
                unfocusedSupportingTextColor = visualTokens.inputContentColor.copy(alpha = 0.72f),
                disabledSupportingTextColor = visualTokens.inputContentColor.copy(alpha = 0.38f),
