...
internal enum class CustomFactionThemeDialogMode {
    DualTone,
    MaterialSingleColor,
}

@Composable
internal fun CustomFactionThemeDialog(
    initialSettings: CustomFactionThemeSettings,
    isCreatingNew: Boolean,
    canDelete: Boolean,
    mode: CustomFactionThemeDialogMode = CustomFactionThemeDialogMode.DualTone,
    ...
    val isMaterialSingleColor = mode == CustomFactionThemeDialogMode.MaterialSingleColor
    ...
    val normalizedSecondary = remember(secondaryHex) { normalizeFactionThemeHex(secondaryHex) }
    val normalizedOutline = remember(outlineHexValue) { normalizeFactionThemeHexOrNull(outlineHexValue) }
    val initialNormalizedPrimary =
        remember(initialSettings.primaryHex) { normalizeFactionThemeHex(initialSettings.primaryHex) }
    ...
    val previewSecondary = remember(normalizedSecondary) { factionThemeColorOrNull(normalizedSecondary ?: "") }
    val initialPrimary = remember(initialNormalizedPrimary) { factionThemeColorOrNull(initialNormalizedPrimary ?: "") }
    val previewOutline =
        remember(normalizedOutline, previewSecondary, outlineHexValue) {
            if (outlineHexValue.isBlank()) {
                previewSecondary
            } else {
                factionThemeColorOrNull(normalizedOutline ?: "")
            }
        }
    ...
    val dialogContentColor =
        if (previewPrimary != null) {
            if (isPreviewDark) Color.White else Color(0xFF1A1C1E) // FactionInkLight
        } else {
            Color.Unspecified
        }
                ...
                text =
                    stringResource(
                        when {
                            ...
                            isCreatingNew -> R.string.config_custom_faction_theme_dialog_title_new
                            else -> R.string.config_custom_faction_theme_dialog_title_edit
                        },
                    ),
            )
        },
            ...
            CompositionLocalProvider(
                ...
                Column(
                        ...
                        IconButton(
                            onClick = {
                                if (isMaterialSingleColor) {
                                    ...
                                    val random = randomCustomFactionThemeColors()
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                text = stringResource(R.string.config_custom_faction_theme_name_label),
                        ...
                        supportingText = {
                            if (trimmedDisplayName.isEmpty()) {
                                Text(text = stringResource(R.string.config_custom_faction_theme_invalid_name))
                            }
                        },
                    )
                    HexColorField(
                        ...
                        label = stringResource(R.string.config_custom_faction_theme_background_label),
                    ...
                    if (!isMaterialSingleColor) {
                        HexColorField(
                            ...
                            label = stringResource(R.string.config_custom_faction_theme_accent_label),
                        ...
                        HexColorField(
                            ...
                            label = stringResource(R.string.config_custom_faction_theme_outline_label),
                            ...
                            focusedBorderColor = previewVisualTokens.inputFocusedBorderColor,
                            unfocusedBorderColor = previewVisualTokens.inputUnfocusedBorderColor,
                            supportingText = stringResource(R.string.config_custom_faction_theme_outline_optional),
                        )
                    }
                    Row(
                        modifier = Modifier.fillMaxWidth(),
                        ...
                        if (canDelete) {
                            TextButton(
                                ...
                                Text(text = stringResource(R.string.config_custom_faction_theme_delete))
                            }
                        }
                    }
                }
                    ...
                    text =
                        stringResource(
                            if (isMaterialSingleColor) {
                                ...
                                R.string.config_custom_faction_theme_delete_title
                            },
                        ),
                )
            },
                ...
                val message =
                    stringResource(
                        if (isMaterialSingleColor) {
                            ...
                            R.string.config_custom_faction_theme_delete_message
                        },
                        displayName,
                    )
                Text(text = message)
...
private fun HexColorField(
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            supportingText = {
                when {
                    isError -> Text(text = stringResource(R.string.config_custom_faction_theme_invalid_hex))
...
private fun customDialogTextFieldColors(
    ...
    if (isMaterialSingleColor) {
        ...
        audioInputTextFieldColors(ThemeStyleOption.FactionTheme)
    }
