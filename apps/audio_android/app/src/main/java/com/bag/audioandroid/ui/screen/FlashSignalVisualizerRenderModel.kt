...
internal data class FlashSignalRenderContext(
...
internal fun buildFlashSignalVisualizerRenderState(
...
@Composable
internal fun rememberFlashSignalRenderContext(
    input: FlashSignalVisualizationInput,
    flashVisualWindow: FlashVisualWindowState,
...
@Composable
internal fun rememberFlashSignalPrimitiveEstimate(
    mode: FlashSignalVisualizationMode,
...
@Composable
internal fun rememberFlashSignalToneSpectrumBuckets(
    pcm: ShortArray,
    sampleRateHz: Int,
    targetBucketCount: Int,
    windowSampleCount: Int,
