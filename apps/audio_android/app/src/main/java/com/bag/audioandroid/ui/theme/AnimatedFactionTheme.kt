...
private const val FactionThemeBackgroundDurationMs = 200
private const val FactionThemeBackgroundLargeShiftDurationMs = 240
private const val FactionThemeStructureDurationMs = 180
private const val FactionThemeAccentDurationMs = 150
...
@Immutable
data class AnimatedFactionThemeSnapshot(
...
@Composable
fun rememberAnimatedFactionThemeSnapshot(theme: FactionThemeOption): AnimatedFactionThemeSnapshot {
        ...
        tween<Color>(
            durationMillis =
                if (isLargePrimaryShift) {
                    FactionThemeBackgroundLargeShiftDurationMs
                } else {
                    FactionThemeBackgroundDurationMs
                },
            easing = FastOutSlowInEasing,
        )
    val structureSpec =
        tween<Color>(
            durationMillis = FactionThemeStructureDurationMs,
            easing = FastOutSlowInEasing,
        )
    val accentSpec =
        tween<Color>(
            durationMillis = FactionThemeAccentDurationMs,
            easing = FastOutSlowInEasing,
        )

    val targetAccentTokens = brandAccentTokens(theme)
    val targetVisualTokens = factionThemeVisualTokens(theme, targetAccentTokens)
    ...
    return AnimatedFactionThemeSnapshot(
        colorScheme = animatedColorScheme,
        accentTokens = animatedAccentTokens,
        visualTokens = animatedVisualTokens,
    )
