...
val FactionThemes: List<FactionThemeOption> =
    listOf(
        ...
        buildFactionThemeOption(
            ...
            primaryColor = Color(0xFF870A0A),
            secondaryColor = Color(0xFFE6A100),
        ...
        buildFactionThemeOption(
            ...
            sampleFlavor = SampleFlavor.ScarletCarnage,
            primaryColor = Color(0xFF381010),
            secondaryColor = Color(0xFFFFAB38),
        ...
        buildFactionThemeOption(
            ...
            primaryColor = Color(0xFF2F4827),
            secondaryColor = Color(0xFFE1CD0A),
        ...
        buildFactionThemeOption(
            ...
            sampleFlavor = SampleFlavor.AncientDynasty,
            primaryColor = Color(0xFFA5712C),
            secondaryColor = Color(0xFF99FFFF),
