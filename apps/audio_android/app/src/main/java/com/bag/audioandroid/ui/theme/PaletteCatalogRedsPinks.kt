...
internal val materialRedsPalettes: List<PaletteOption> =
    listOf(
        vividPalette(
            id = "blush",
            family = PaletteFamily.Reds,
        ...
        vividPalette(
            id = "red",
            family = PaletteFamily.Reds,
            titleResId = R.string.palette_red_title,
            primary = Color(0xFFF44336),
            primaryContainer = Color(0xFFFFDAD6),
            secondary = Color(0xFF8C4C4A),
            tertiary = Color(0xFF7E5B1A),
            background = Color(0xFFFFF8F7),
            dark =
                darkSeed(
                    ...
                    secondary = Color(0xFFE2B8B5),
                    tertiary = Color(0xFFF2C985),
                ),
        ),
        vividPalette(
            id = "mars_relic",
