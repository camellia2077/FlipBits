...
set(FLIPBITS_ENABLE_ASYNC_ENCODE_JOB 1)
if(EMSCRIPTEN)
    set(FLIPBITS_ENABLE_ASYNC_ENCODE_JOB 0)
endif()
...
function(flipbits_apply_toolchain_capabilities target_name)
    target_compile_definitions(
        ...
        PUBLIC
            ...
            FLIPBITS_ENABLE_ASYNC_ENCODE_JOB=$<IF:$<BOOL:${FLIPBITS_ENABLE_ASYNC_ENCODE_JOB}>,1,0>
    )
