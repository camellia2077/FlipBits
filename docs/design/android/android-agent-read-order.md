...
1. 先看 [apps/audio_android/README.md](../../../apps/audio_android/README.md) 的“快速定位 / 常见改动入口”。
...
再按需读：
- [android-ui-structure.md](../../architecture/android/android-ui-structure.md)
...
先读：
- [android-flash-visual.md](../../architecture/android/android-flash-visual.md)
...
- [android-custom-theme-import-format.md](android-custom-theme-import-format.md)
...
先读：
- [android-translation-workflow.md](android-translation-workflow.md)

再按需读：
- [android-translation-tooling-agent-index.md](android-translation-tooling-agent-index.md)
...
再按需读：
- [android-app-architecture.md](../../architecture/android/android-app-architecture.md)
...
先读：
- [android-automation-agent-index.md](../../architecture/android/android-automation-agent-index.md)
