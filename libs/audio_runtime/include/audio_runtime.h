...
audio_runtime_playback_session_state audio_runtime_load(int total_samples, int sample_rate_hz);
...
float audio_runtime_progress_fraction(const audio_runtime_playback_session_state* state);
...
int64_t audio_runtime_elapsed_ms(const audio_runtime_playback_session_state* state);
int64_t audio_runtime_total_ms(const audio_runtime_playback_session_state* state);
