...
[identity_rule]
Never translate these product/protocol terms; preserve exact English spelling and casing: flash, pro, mini, ultra, ASCII, UTF-8, Hex, Binary, Morse, MFSK16, Bd, Emoji, Token, Tokens, Debug, Demo mode, Animation, Mix, English, Deutsch, Español, Português, Français, Italiano, Русский, Українська, 한국어, 日本語, 简体中文, 繁體中文, Polski, Altum Gothicum.
