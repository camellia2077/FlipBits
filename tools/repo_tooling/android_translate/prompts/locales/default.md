...
Use stable terminology for input rules, playback speed, saved audio, read/decode results, Visual/Lyrics tabs, byte/token explanations, and low/high bit visualization.
...
[key_alignment_rule]
When filling missing entries, match the current XML file's established terminology for audio, characters/bytes, input rules, Visual/Lyrics, Hex/Binary/Morse, payload, token, and low/high carriers.
