...
def test_mini_summary_includes_mini_visual_perf_rollup(tmp_path) -> None:
    ...
    raw_log.write_text(
        "\n".join(
            [
                "05-19 10:00:00.000 D/MiniAutomation(12345): received scenario=ui speed=wpm15 playMs=10000 input=text text=mini_sync_test sampleLength=short",
                ...
                "05-19 10:00:02.100 D/MiniAlignmentPerf(12345): speed=wpm15 playing=true frameSamples=480 visualSample=1200 lyricsSample=1195 sampleDelta=5 visualGroup=1 visualBitOffset=2 token=0 tokenText=mini tokenProgress=0.25 lyricBitOffset=3 tone=true",
            ]
        ),
        encoding="utf-8",
    )
